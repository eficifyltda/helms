...
{{/*
Check if backup should be enabled - SEMPRE HABILITADO EM PRODUÇÃO
*/}}
...
{{/*
Check if replication should be enabled - SEMPRE HABILITADO EM PRODUÇÃO
*/}}
{{- define "postgresql.replication.enabled" -}}
{{- if .Values.postgresql.replication }}
{{- default true .Values.postgresql.replication.enabled }}
{{- else }}
{{- true }}
{{- end }}
{{- end }}
