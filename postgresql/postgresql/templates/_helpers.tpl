...
Redis labels
*/}}
{{- define "postgresql.redis.labels" -}}
{{ include "postgresql.labels" . }}
...
*/}}
{{- define "postgresql.redis.selectorLabels" -}}
{{ include "postgresql.selectorLabels" . }}
app.kubernetes.io/component: redis
{{- end }}

{{/*
Redis Data Integration labels
*/}}
{{- define "postgresql.redisDataIntegration.labels" -}}
{{ include "postgresql.labels" . }}
app.kubernetes.io/component: redis-data-integration
{{- end }}

{{/*
Redis Data Integration selector labels
*/}}
{{- define "postgresql.redisDataIntegration.selectorLabels" -}}
{{ include "postgresql.selectorLabels" . }}
app.kubernetes.io/component: redis-data-integration
{{- end }}
...
{{/*
Generate hostname for Read Replica Ingress
...
{{- $hostnameServer = "k8s" }}
{{- end }}
{{- printf "%s-db-ra.%s.eficify.cloud" $random $hostnameServer }}
{{- else }}
{{- "read-replica.example.com" }}
{{- end }}
{{- end }}
